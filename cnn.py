...
train['samples'] = np.array(train['samples'][0:5000]).reshape(5000, 28, 28)
...
test['samples'] = np.array(test['samples'][0:500]).reshape(500, 28, 28)
...
predicao = np.argmax(history.model.predict(imagem))
...
predicao = np.argmax(history.model.predict(zero_legivel_processado.reshape(1, 28, 28)))
...
predicao = np.argmax(history.model.predict(um_legivel_processado.reshape(1, 28, 28)))
...
predicao = np.argmax(history.model.predict(dois_legivel_processado.reshape(1, 28, 28)))
...
predicao = np.argmax(history.model.predict(dois_ilegivel_processado.reshape(1, 28, 28)))
